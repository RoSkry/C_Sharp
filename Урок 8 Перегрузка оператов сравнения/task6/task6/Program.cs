...
namespace SimpleProject
{
    ...
    class Rectangle : Quadrangle
    {
        ...
        public static implicit operator Rectangle(Square s)//из меньшего в большее не явное без потерь 
        {
    ...
    class Square : Quadrangle
    {
        ...
        public static explicit operator Square(Rectangle rect)//потеря данных
        {
